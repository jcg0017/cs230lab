...
function stars($av){
    ...
    if ($av == 0) {
        for ($i=0; $i < 5; $i++) { 
            $s .= '<i class="fab fa-phoenix-framework fa-2x" style="color:grey"></i>';
        }  
    }
    for ($i=0; $i < floor($av); $i++) { 
        $s .= '<i class="fab fa-phoenix-framework fa-2x" style="color:goldenrod"></i>';
    }
    if (($av - floor($av)) > 0.4) {
        $s .= '<i class="fab fa-phoenix-squadron fa-2x" style="color:goldenrod"></i>';
    }
    return $s;
}