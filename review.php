    ...
    <div class="container" align="center" style="max-width: 800px;">
        ...
        <div class="my-auto">
            ...
            <form id="review-form" action="includes/review-helper.php" method="post">
                ...
                <div class="container">
                    <i class="fab fa-phoenix-framework fa-2x star-rev" data-index="1"></i>
                    <i class="fab fa-phoenix-framework fa-2x star-rev" data-index="2"></i>
                    <i class="fab fa-phoenix-framework fa-2x star-rev" data-index="3"></i>
                    <i class="fab fa-phoenix-framework fa-2x star-rev" data-index="4"></i>
                    <i class="fab fa-phoenix-framework fa-2x star-rev" data-index="5"></i>
                </div>
                <div class="form-group" style="margin-top: 15px;">
                    ...
                    <textarea name="review" id="review-text" cols="82" rows="3"
